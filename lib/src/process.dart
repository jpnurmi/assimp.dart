...
///
/// **Note:** Some steps are influenced by properties set on the Scene itself.
///
/// See also:
/// - [Scene.fromFile()]
/// - [Scene.setProperty()]
class ProcessFlags {
  ...
  static const int calculateTangentSpace = 0x1;
  ...
  static const int joinIdenticalVertices = 0x2;
  ...
  static const int triangulate = 0x8;
  ...
  static const int removeComponent = 0x10;
  ...
  ///
  /// This flag may not be specified together with [generateSmoothNormals].
  static const int generateNormals = 0x20;
  ...
  /// importer properties. The default values are [AI_SLM_DEFAULT_MAX_VERTICES]
  /// and [AI_SLM_DEFAULT_MAX_TRIANGLES].
  ///
  /// Note that splitting is generally a time-consuming task, but only if there's
  /// something to split. The use of this step is recommended for most users.
  static const int splitLargeMeshes = 0x80;
  ...
  /// range.
  static const int preTransformVertices = 0x100;
  ...
  static const int limitBoneWeights = 0x200;
  ...
  ///  post-processing is not possible and the data is not usable at all.
  ///  The import fails. #Importer::GetErrorString() or #aiGetErrorString()
  ///  carry the error message around.</li>
  /// - Warning: There are some minor issues (e.g. 1000000 animation
  ///  keyframes with the same time), but further post-processing and use
  ...
  static const int validateDataStructure = 0x400;
  ...
  static const int improveCacheLocality = 0x800;
  ...
  static const int removeRedundantMaterials = 0x1000;
  ...
  static const int fixInfacingNormals = 0x2000;
  ...
  static const int sortByPType = 0x8000;
  ...
  ///   1. Specify the [findDegenerates] flag.
  ///   2. Set the [AI_CONFIG_PP_FD_REMOVE] importer property to
  ...
  ///   1. Specify the [findDegenerates] flag.
  ///   2. Specify the [sortByPType] flag. This moves line and
  ///      point primitives to separate meshes.
  ///   3. Set the [AI_CONFIG_PP_SBP_REMOVE] importer property to
  ...
  static const int findDegenerates = 0x10000;
  ...
  /// properly.
  static const int generateUVCoords = 0x40000;
  ...
  static const int transformUVCoords = 0x80000;
  ...
  static const int findInstances = 0x100000;
  ...
  static const int optimizeMeshes = 0x200000;
  ...
  static const int optimizeGraph = 0x400000;
  ...
  static const int debone = 0x4000000;
  ...
  static const int globalScale = 0x8000000;

  /// A post-processing step to embed of textures.
  ///
  ...
  static const int embedTextures = 0x10000000;

  // static const int genEntityMeshes = 0x100000,
  // static const int optimizeAnimations = 0x200000
  // static const int fixTexturePaths = 0x200000

  static const int forceGenerateNormals = 0x20000000;
  ...
  static const int dropNormals = 0x40000000;

  static const int generateBoundingBoxes = 0x80000000;

  /// Shortcut flag for Direct3D-based applications.
  ///
  /// Supersedes the [makeLeftHanded], [flipUVs] and [flipWindingOrder] flags.
