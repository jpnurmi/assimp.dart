...
void main() {
  ...
  test('size', () {
    Material a = Material.fromNative(allocate<aiMaterial>());
    Material b = Material.fromNative(allocate<aiMaterial>());
    Material aa = Material.fromNative(a.ptr);
    Material bb = Material.fromNative(b.ptr);
    expect(a, equals(a));
    expect(a, equals(aa));
    expect(b, equals(b));
    expect(b, equals(bb));
